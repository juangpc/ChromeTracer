...
#ifdef TRACE
#define __TRACE_FUNC() ChromeTracer::Tracer _t__LINE__(__PRETTY_FUNCTION__, __FILE__, __LINE__)
#define __TRACER_ENABLE ChromeTracer::Tracer::enable("chrome_tracer.json");
#define __TRACER_DISABLE ChromeTracer::Tracer::disable();
#define __TRACE_VALUE(NAME, VALUE) ChromeTracer::Tracer::traceQuantity(NAME, VALUE)
#else
#define __TRACE_FUNC() 
#define __TRACER_ENABLE
#define __TRACER_DISABLE
#define __TRACE_VALUE()
#endif
